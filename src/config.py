...
class Config:
    ...
    def __post_init__(self):
        ...
        self.SPORTSDB_SPORT_MAP = {
            ...
            "soccer_brazil_campeonato": "Soccer", "soccer_argentina_primera_division": "Soccer",
            "soccer_usa_mls": "Soccer", "soccer_mexico_ligamx": "Soccer",
            "soccer_colombia": "Soccer", "americanfootball_nfl": "American Football",
            "basketball_nba": "Basketball", "baseball_mlb": "Baseball",
            "icehockey_nhl": "Ice Hockey", "americanfootball_ncaaf": "American Football",
            "basketball_euroleague": "Basketball", "mma_mixed_martial_arts": "Fighting",
        }
